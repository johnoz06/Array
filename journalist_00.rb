...
def five_handle
    ...
    if nbr >= 1
        puts " "
        puts "La question était: Combien y-a-t'il de handle contenant #{nbr} caractères (le @ ne compte pas pour un caractère)"
        puts " "
